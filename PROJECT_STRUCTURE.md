...
SwiftTavern is a macOS desktop app for AI character roleplay conversations. MVVM+Services architecture, Swift `@Observable` macro, macOS 14+, single dependency (Yams). Supports OpenRouter, OpenAI, Claude, Gemini, and Ollama providers. Compatible with SillyTavern TavernCardV2 character cards.
