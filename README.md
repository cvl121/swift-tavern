...
- **Multiple AI providers** -- connect to OpenRouter, OpenAI, Claude, Gemini, or run models locally with Ollama
- **Bring your own API key** -- your keys are stored securely in the macOS Keychain, never sent anywhere except to your chosen provider
...
- **World Info & Character Books** -- add lore and context that gets injected into conversations based on keywords
- **Personas** -- create and switch between different user identities with custom names, descriptions, and avatars
- **Chat history** -- all conversations are saved automatically and searchable
- **Chat styling** -- customize colors for dialogue, actions, and narrative text
- **SillyTavern import** -- bring over your existing characters, chats, world info, and personas from SillyTavern
- **Light & dark mode** -- adapts to your system appearance
...
3. **Import or create a character** -- import a TavernCardV2 PNG/JSON file, or create a new character from scratch.
...
- **Characters, chats, and settings** are saved in `~/Library/Application Support/SwiftTavern/`
